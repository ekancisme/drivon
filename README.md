...
education: Software Engineering @ FPT University ар N?ng
location: ар N?ng, Vi?t Nam
stack:
...
DEVELOPER     Lъ Th? Cu?ng (@ekancisme)
TECH POWER    Java 17 З Spring Boot 3 З MongoDB З React З Docker
PARTY MODE    Teamwork З Agile/Scrum З Clean Code З Code Review
